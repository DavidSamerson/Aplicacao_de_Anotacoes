                    ...
                    <div id="login-access" class="tab-pane fade active in">
                        ...
                        <form method="post" accept-charset="utf-8" autocomplete="off" role="form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="login" id="login" placeholder="Email" tabindex="1" required/>
                            </div>
                            <div class="form-group">
                                <label for="password" class="sr-only">Password</label>
                                <input type="password" class="form-control" name="password" id="password" placeholder="Password" tabindex="2" required/>
                            </div>

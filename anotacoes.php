        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    <p class="textoAzul">Anotações.com</p>
                </a>
            </div>
            ...
            <div class="col-md-10 col-sm-12 col-xs-12 pull-right" style="margin-top: 20px;" align="center">
                ...
                <div class="col-md-2 col-sm-5 col-xs-12 configNotasEspaco pull-right" align="center">
                    ...
                    <div class="pull-right">
                        <a href="nota.php?id=<?php echo $n['id']; ?>&comando=apagar" style="padding: 10px; margin-left: 50%;" class="sombreamento">X</a>
                    </div>
                    <!-- Nome -->
                    <div class="tituloNota col-sm-12 col-xs-12"><strong><?php echo $n['nome'];?></strong></div>
                    <!-- Mensagem -->
                    <div class="configNotas col-md-12 col-xs-12" align="center">
                        <?php echo $n['mensagem']; ?>
                    </div>
                    <!-- Data -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <a onclick="editaDadosModal('<?php echo $n['id']; ?>','<?php echo $n['nome']; ?>','<?php echo $n['data']; ?>', '<?php echo $n['mensagem'];?>');" data-toggle="modal" data-target="#myModal">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-4 col-xs-12">
                <form>
                    <fieldset>
                        <legend>
                            <h3 style="color: #333333;">Fale Conosco
                                <h3>
                                    <hr>
                        </legend>

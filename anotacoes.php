...
<!---------------------------------------------------------------------------------------------------------------------- -->
				...
				<div class="col-md-9 col-sm-12 col-xs-12 pull-right" style="margin-top: 20px;" align="center">
					<?php foreach ($nota as $n) : ?>
					  <?php if (isset($_SESSION['nota'][$n['id']]) && $n['id'] > 0 && $n['id'] != ''):?>

					<div class="col-md-3 col-sm-5 col-xs-12 configNotasEspaco pull-right" align="center">
						<!-- Sair -->
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<span class="glyphicon glyphicon-edit" style="padding:10px; margin-top: 5%"></span></a>
						</div>
					</div>
